...
>
> **23 lectures total.** L6 (Regularization) is comprehensive — spans two class sessions.
...
| # | Lecture | Reading |
|:-:|---------|---------|
| 23 | Efficient Inference, Agents &amp; Open Problems | Chip Huyen blog; HF inference docs; Dao 2022 (FlashAttention); Hinton 2015 (distillation); Anthropic interpretability blog |
...
- **L23 · Efficient Inference + frontier** — KV-cache, quantization, agents, interpretability. Use Chip Huyen blog + HF docs.
