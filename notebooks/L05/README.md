...
The four canonical companions for the current public Lecture 5 are:

1. [`00_full_batch_sgd_minibatch.ipynb`](00_full_batch_sgd_minibatch.ipynb) — **Batch/SGD/Minibatches + Estimators**
2. [`02_ewma_momentum.ipynb`](02_ewma_momentum.ipynb) — **EWMA + Momentum**
3. [`03_adaptive_optimizers_constraints.ipynb`](03_adaptive_optimizers_constraints.ipynb) — **RMSProp + Adam + Constraints**
4. [`04_xor_optimizer_lab.ipynb`](04_xor_optimizer_lab.ipynb) — **XOR Optimizer Lab**
...
Keep these four synchronized with the Typst deck, course page, and teaching
